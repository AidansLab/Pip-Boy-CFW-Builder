...
let submenuInvAttach = () =>
{
	...
	function d()
	{
		...
		let e = 0,
			d = 220,
			c = 40;
		const f = ["EXT TERMINAL", "RAD METER", "FLASHLIGHT"/*CameraModuleInsert_Title*/];
		f.forEach((b, f) =>
		{
...
E.showMenu = function(g)
{
	...
	var c = {
		...
		move: function(e)
		{
			...
			{
				let b = a.selected;
				a.wrapSelection ? a.selected = (e + a.selected + d.length) % d.length : a.selected = E.clip(a.selected + e, 0, d.length - 1), b != a.selected && !Pip.radioKPSS /*CustomRadioPatchInsert_customFlag*/ && Pip.knob1Click(e)
			}
			c.draw()
		}
	};
