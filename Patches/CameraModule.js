...
let submenuCamera = () =>
{
    ...
    let brightness = 0;
    let fileIndex = 1;
    var ThrobberInterval = null;
    var ThrobberTimeout = null;
    let Throbbers = {
    ...
    {
        if (fs.statSync("IMGS/image_" + fileIndex + ".img").size < 30000)
        {
            g.setFontAlign(0, 0);
        ...
        // Open the file
        const f = E.openFile("IMGS/image_" + fileIndex + ".img", "r");
